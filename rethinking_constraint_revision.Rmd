...
These correlational models rest on what I call the "diametric assumption" that beliefs are constrained when they covary across people -- people who are high on the first attitude are high on the second, while people who are low on the first attitude are low on the second. While this is good evidence for the static variation of constraint -- that two issues are related in the population -- it is not necessarily indicative of a cognitive connection in people's heads. According to this logic, if liberals and conservatives have opposite positions they are assumed to see a link between them, even if they, in their own heads, do not. If they do not have opposite positions, neither is constrained in their thinking. This is true even if members of both groups subjectively understand their belief system to imply a position (the theoretical definition of the cognitive version of constraint).
...
When attitudes are observed over time, people appear to change quite frequently and in non-durable ways [@alwin; @houthastings]. While this movement is often interpreted as "measurement error," a more theoretically grounded interpretation suggests that this transient change reflects a degree of ambivalence among the population [@zaller2012]. In this framework, people internalize diverse considerations in favor of and against an issue and, on the basis of short-term temporary influence, connstruct new opinions at the time of the interview. The fact that in several domains stability is associated with the attention people pay to the topic suggests that variation is not random measurement error, but patterned attitude structuring [@freeder2019]. 
...
A key finding from decades of research in cultural sociology and public opinion research is that people consume diverse and contradictory bits of culture, often storing this heterogeneous mixture without taking time to reconcile its contraditions [@martin2010; @swidler; @zaller1992]. Without strong motivation, people have a hard time keeping conflicting considerations out of their heads [@martin; @zaller]. As a result, "our heads are full of images, opinions, and information, untagged as to truth value, to which we are inclined to attribute accuracy and plausibility" [@dimaggio1997: p. 267]. In interviews they tend to draw on these diverse considerations, often contradicting themselves, and in repeated interviews people appear to vascillate much more than we would expect if they were stable opinion holders. 

At the same time, an often smaller proportion of the population do clearly articulate the same opinions over time. They use these beliefs to guide their behaviors and patterns of association ... and SOMETHING ELSE. 
...
Importantly, attitude strength is not well measured by the intensity with people give a response at a single point in time. Ambivalent people can feel attitudes strongly in one wave and feel the opposite belief strongly in a subsequent wave without any acknowledgement of their incompatibility [@zaller1992]. The empirical signature of strong attitudes is their stability -- people do not change them over time. This is in part because these attitudes become attached to their sense of self, and in part because ... that insulate themselves from change.  
...
The preceding discussion suggests an empirical signature of constraint should be a lack of movement in ideas over time. When people view attitudes as linked, holding one stable makes it more difficult to change another. 
